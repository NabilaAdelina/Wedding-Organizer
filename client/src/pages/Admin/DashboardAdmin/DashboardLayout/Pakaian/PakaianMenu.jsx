...
import AddPakaianButton1 from './AddPakaianButton1';
import AddPakaianButton2 from './AddPakaianButton2';
    ...
    return (
        ...
        <div className="p-6 bg-white border rounded-lg shadow-md m-3">
            ...
            <div className="flex space-x-2 m-5">
                <AddPakaianButton1 onAdd={handleAddPakaian} />
            </div>
            <div className="flex justify-center">
                <div className="flex flex-col justify-center">
                    <div className='grid grid-cols-3 gap-14'>
                        {pakaianData1.slice(0, visibleCount).map((pakaian, index) => (
                            <PakaianCard
                                key={index}
                                url={pakaian.url}
                                name={pakaian.name}
                    ...
                    {visibleCount < pakaianData1.length && (
            ...
            <div className="flex space-x-2 m-5">
                <AddPakaianButton2 onAdd={handleAddPakaian} />
            </div>
            <div className="flex justify-center">
                <div className="flex flex-col justify-center">
                    <div className='grid grid-cols-3 gap-14'>
                        {pakaianData2.slice(0, visibleCount).map((pakaian, index) => (
                            <PakaianCard
                                key={index}
                                url={pakaian.url}
                                name={pakaian.name}
                    ...
                    {visibleCount < pakaianData2.length && (
                        <div className='flex justify-center m-10'>
                            <button
                                onClick={handleShowMore}
                                className='bg-transparent hover:bg-gray-100 text-primary1 font-semibold py-2 px-[100px] border border-primary1'
